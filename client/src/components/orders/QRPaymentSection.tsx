...
export const QRPaymentSection: React.FC<QRPaymentSectionProps> = ({
  ...
  return (
    <div className="bg-gray-50 border-l-4 border-black p-4 rounded-lg mb-4">
      <div className="flex items-start gap-3 mb-3">
        <FaQrcode className="text-black text-lg mt-0.5 flex-shrink-0" />
        <div className="flex-1">
          <h4 className="text-sm font-semibold text-gray-900 mb-2">Thanh toán QR Code</h4>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-shrink-0">
                <div className="w-[200px] mx-auto">
                  <div className="relative bg-white p-3 rounded-lg border-2 border-black shadow-md">
                    <img src={qrUrl} alt="QR Code" className="w-full h-full object-contain" />
                    <div className="absolute -top-1.5 -left-1.5 bg-white rounded shadow-sm p-0.5 px-1">
                      <span className="text-[8px] font-semibold text-black">SEPAY</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 space-y-2 text-xs">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex justify-between py-1 bg-gray-100 rounded px-2 -mx-2">
                    <span className="text-gray-700 font-medium">Nội dung CK</span>
                    <span className="font-mono font-bold text-black">STNP_{orderId}</span>
                  </div>
                </div>
              </div>
            </div>
          ) : (
            <div className="w-[200px] aspect-square flex flex-col items-center justify-center bg-gray-50 rounded-lg border-2 border-dashed border-gray-400">
              <FaSpinner className="text-3xl text-black animate-spin mb-2" />
