...
export const ContactInfo = () => {
  const contactItems: ContactInfoItem[] = [
    ...
    },
    {
      ...
      title: 'Email',
      content: 'h.sangg.r@gmail.com',
      link: 'mailto:h.sangg.r@gmail.com',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Địa chỉ',
      content: '124 Đường số 17, Phường 11, Quận Gò Vấp, TP. Hồ Chí Minh',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {contactItems.map((item, index) => (
          ...
          >
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-gray-50 flex items-center justify-center text-gray-700">
                {item.icon}
              </div>
              <div className="flex-1 min-w-0">
                ...
                {item.link ? (
                  <a
                    href={item.link}
                    className="text-base font-medium text-gray-900 hover:text-black transition-colors break-words"
                  >
                    {item.content}
                  </a>
                ) : (
        ...
        <div className="flex items-center gap-4">
          {[
            ...
            { 
              ...
              color: 'bg-black',
              url: 'https://www.tiktok.com/@piin.nhs'
            },
          ].map((social, index) => (
            <motion.a
              key={index}
