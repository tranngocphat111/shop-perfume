      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-6">
        ...
        <div className="w-full md:w-auto md:flex-[1] flex flex-col md:items-end gap-3 md:min-w-[200px] md:max-w-[280px]">
          ...
          <button 
            ...
            className="w-full md:w-auto bg-black text-white hover:bg-gray-800 px-4 md:px-8 py-2 md:py-2.5 rounded-xl font-bold text-base md:text-lg shadow-lg transition-all flex justify-center items-center gap-2"
          >
            Tiếp tục thanh toán
            <ArrowRight size={18} />
          </button>
