      ...
      <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-[200px] mx-auto">
            {qrUrl ? (
              <div className="relative bg-white p-3 rounded-lg border-2 border-slate-300 shadow-md">
                ...
                />
                <div className="absolute -top-1.5 -left-1.5 bg-white rounded shadow-md p-1 px-2">
                  <span className="text-xs font-semibold text-blue-600">SEPAY</span>
                </div>
              </div>
            ) : (
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="space-y-2.5 text-sm">
            ...
            <div className="flex justify-between py-2.5 bg-blue-50 rounded px-3 -mx-3">
              <span className="text-slate-700 font-medium">Nội dung CK</span>
              <span className="font-mono font-bold text-blue-600 text-sm">STNP_{orderId}</span>
            </div>
          </div>
