      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-200">
        ...
        <div className="p-8">
          ...
          <div className="mt-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
            <div className="flex items-start">
              <svg
                className="w-5 h-5 text-slate-600 mt-0.5 mr-2 flex-shrink-0"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
              ...
              <div className="text-sm">
                ...
                <p className="text-slate-600">
                  Email:{" "}
                  <code className="bg-white px-2 py-1 rounded text-slate-800 font-mono text-xs">
                    shopperfume.admin@gmail.com
                  </code>
                </p>
